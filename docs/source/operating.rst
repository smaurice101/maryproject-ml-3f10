[maryproject-ml-3f10] Operating Details
====================================

Generated On: 2024-10-17 23:54:20 UTC
...
.. important::
   ...
   **not be valid if your [maryproject-ml-3f10] container is NOT running**.

.. tip::
   You must have your [maryproject-ml-3f10] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=37689  \-\-env VIPERVIZPORT=51497  \-\-env GITUSERNAME='smaurice101'  \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180'  \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:51497/iot-failure-machinelearning.html?topic=iot-preprocess,iot-ml-prediction-results-output&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:51497/viperlogs.html?topic=viperlogs&append=0
...
.. important::
   maadsdocker/maryproject-ml-3f10-amd64 (https://hub.docker.com/r/maadsdocker/maryproject-ml-3f10-amd64)
...
.. important::
   docker run -d -p 55213:55213 -p 45949:45949 -p 56577:56577 \-\-env TSS=0 \-\-env SOLUTIONNAME=maryproject-ml-3f10 \-\-env SOLUTIONDAG=solution_preprocessing_ml_dag-maryproject-ml-3f10 \-\-env GITUSERNAME=smaurice101  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git \-\-env SOLUTIONEXTERNALPORT=55213  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=45949  \-\-env SOLUTIONVIPERVIZPORT=56577 \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env EXTERNALPORT=37689 \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env VIPERVIZPORT=51497 \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  maadsdocker/maryproject-ml-3f10-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=56577
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=55213
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - maadsdocker/maryproject-ml-3f10-amd64
...
It can be accessed by entering: http://localhost:45949
...
.. important::
   http://localhost:56577/iot-failure-machinelearning.html?topic=iot-preprocess,iot-ml-prediction-results-output&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:56577/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:56577/<html file>
...
[maryproject-ml-3f10] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/smaurice101/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/maryproject-ml-3f10
...
.. important::
   https://maryproject-ml-3f10.readthedocs.io
...
.. important::
   solution_preprocessing_ml_dag-maryproject-ml-3f10
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=55213, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=43179, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=43879, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=35403, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=38439, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=33091, HPDEHOST=127.0.1.1, HPDEPORT=32791, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=38855

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-7540-maryproject-ml-3f10,solution_preprocessing_ml_dag-maryproject-ml-3f10, python-preprocess-5082-maryproject-ml-3f10,solution_preprocessing_ml_dag-maryproject-ml-3f10, python-ml-8793-maryproject-ml-3f10,solution_preprocessing_ml_dag-maryproject-ml-3f10, python-predict-7020-maryproject-ml-3f10,solution_preprocessing_ml_dag-maryproject-ml-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
